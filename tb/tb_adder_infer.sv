...
module tb_adder_infer;
  localparam int TOP_K = 10;
  localparam int N_LAYER = 3;
  localparam int N_HEAD = 3;
  localparam int D_MODEL = 48;
  localparam int D_FF = 192;
  localparam int MAX_CTX = 6;
  localparam int VOCAB = 10;
  localparam int MAX_PROMPT = 6;
